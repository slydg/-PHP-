        ...
        <section id="bricks" class="with-top-sep" style="height:75%">
            ...
            <div class="row masonry">
                ...
                <div class="bricks-wrapper">
                    ...
                    <?php
                    $result1 = $connection->query("SELECT * FROM things WHERE uid = '$user'");
                    ...
                    for ($j = 0; $j < $rows; ++$j) {
                        ...
                        <article class="brick entry format-standard animate-this">
                            ...
                            <div class="entry-thumb">
                                <a href="obpage/<?php echo $row[0]; ?>.php" class="thumb-link">
                                    <img src="things/<?php echo $row[7]; ?>" alt="Liberty">                      
                                </a>
                            </div>
                            ...
                            <div class="entry-text">    
                                ...
                                <div class="gz">
                                    <a id="gz" href="php/xiugai.php?pid=<?php echo $row[0]; ?>">
                                        <img src="obpage/images/xg.jpg" alt="">
                                    </a>
                                </div>
                                <div class="jy">
                                    <a href="php/xiajia.php?pid=<?php echo $row[0]; ?>">
                                        <img src="obpage/images/sc.jpg" alt="">
                                    </a>
                                </div> 
                            </div>
                        </article> <!-- end article -->
