        ...
        <section id="content-wrap" class="blog-single">
            <div class="row">
                <div class="col-twelve">
                                    ...
                                    <ul class="slides">
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/42-1.jpeg');"></div>
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/42-2.jpeg');"></div>
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/42-3.jpeg');"></div>
                    ...
                    <?php if($user == $uid ){ ?>
                    <div class="gz">
                        <a id="xg" href="../php/xiugai.php?pid=42">
                            <img src="images/xg.jpg" alt="">
                        </a>
                    </div>
                    <div class="jy">
                        <a href="../php/xiajia.php?pid=42">
