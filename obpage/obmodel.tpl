        ...
        <section id="content-wrap" class="blog-single">
            <div class="row">
                <div class="col-twelve">
                                    ...
                                    <ul class="slides">
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/{obpic1}');"></div>
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/{obpic2}');"></div>
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/{obpic3}');"></div>
                    ...
                    <?php if($user == $uid ){ ?>
                    <div class="gz">
                        <a id="xg" href="../php/xiugai.php?pid={pid}">
                            <img src="images/xg.jpg" alt="">
                        </a>
                    </div>
                    <div class="jy">
                        <a href="../php/xiajia.php?pid={pid}">
