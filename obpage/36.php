                ...
                <div class="col-twelve">
                    ...
                    <article class="format-standard">
                                    ...
                                    <ul class="slides">
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/36-1.jpeg');"></div>
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/36-2.jpeg');"></div>
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/36-3.jpeg');"></div>
                        ...
                        <div class="primary-content">
                            ...
                            <h1 class="page-title">DIOR的古龙水</h1>
                    ...
                    <?php if($user == $uid ){ ?>
                    <div class="gz">
                        <a id="xg" href="../php/xiugai.php?pid=36">
                            <img src="images/xg.jpg" alt="">
                        </a>
                    </div>
                    <div class="jy">
                        <a href="../php/xiajia.php?pid=36">
