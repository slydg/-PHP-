        ...
        <section id="content-wrap" class="blog-single">
            <div class="row">
                <div class="col-twelve">
                                    ...
                                    <ul class="slides">
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/16-1.jpeg');"></div>
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/16-2.jpeg');"></div>
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/16-3.jpeg');"></div>
                    ...
                    <?php if($user == $uid ){ ?>
                    <div class="gz">
                        <a id="xg" href="../php/xiugai.php?pid=16">
                            <img src="images/xg.jpg" alt="">
                        </a>
                    </div>
                    <div class="jy">
                        <a href="../php/xiajia.php?pid=16">
