                ...
                <div class="col-twelve">
                    ...
                    <article class="format-standard">
                                    ...
                                    <ul class="slides">
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/51-1.jpeg');"></div>
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/51-2.jpeg');"></div>
                                        ...
                                        <li>
                                            <div class="featured-post-slide">
                                                ...
                                                <div class="post-background" style="background-image:url('../things/51-3.jpeg');"></div>
                        ...
                        <div class="primary-content">
                            ...
                            <p class="lead">读纳兰词，品朗读者，赏挪威的森林</p>
                            <br>
                            <h3>
                                对方的需求：
                            </h3>
                    ...
                    <?php if($user == $uid ){ ?>
                    <div class="gz">
                        <a id="xg" href="../php/xiugai.php?pid=51">
                            <img src="images/xg.jpg" alt="">
                        </a>
                    </div>
                    <div class="jy">
                        <a href="../php/xiajia.php?pid=51">
